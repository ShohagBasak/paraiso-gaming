        ...
        <div className="bg-[#121820]/80 backdrop-blur-md p-8 rounded-2xl border border-slate-700 shadow-2xl">
            <form onSubmit={handleSubmit(handleRegistration)}>
                <fieldset className="fieldset w-full space-y-6">
                    ...
                    <button
                        type="submit"
                        className="w-full mb-5 py-3 bg-cyan-600 hover:bg-cyan-500 text-black font-bold uppercase tracking-widest rounded-lg transition-all duration-300 shadow-[0_0_15px_rgba(6,182,212,0.4)] hover:shadow-[0_0_25px_rgba(6,182,212,0.6)] mt-4 active:scale-95"
                    >
                        Login
                    </button>
                </fieldset>
                <p className='text-base-100'>New at Paraiso Gaming ? Please <Link to="/login" className='text-cyan-400 underline'>Register</Link></p>
            </form>
        </div>
    );
};

      ...
      <div className="relative z-10 max-w-7xl mx-auto space-y-10">
        ...
        <div className="text-center space-y-3 max-w-3xl mx-auto">
          ...
          <p className="text-xs sm:text-sm text-slate-400 font-mono leading-relaxed">
            Welcome to <span className="text-cyan-400 font-bold">Paraiso Roleplay</span> Highscores. Live player statistics gathered directly from our SA-MP server (<span className="text-slate-300 font-bold">samp.pgaming.net:7777</span>). Statistics are updated automatically every 5 minutes.
          </p>
        </div>
